  ...
  return (
    <nav className="fixed top-4 left-0 right-0 z-50 flex justify-center" style={{ zIndex: 100 }}>
      <div className="bg-black/70 backdrop-blur-xl border border-white/10 rounded-full px-4 py-3 flex items-center justify-between md:justify-start gap-4 md:gap-8 max-w-3xl w-full mx-3 md:mx-4">
        ...
        >
          <span className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-[rgba(245,245,240,0.3)] text-[#f5f5f0] text-[10px] tracking-[0.2em]">
            FK
          </span>
          <span>FAIZ</span>
        </Link>
          ...
          {navLinks.map((link) => {
            ...
            return (
              <Link
                ...
                className={
                  isActive
                    ? "text-[#f5f5f0] text-[10px] lg:text-xs uppercase tracking-wider font-medium"
        ...
        <a
          href="/resume.pdf"
          className="hidden md:flex items-center gap-2 border border-[rgba(245,245,240,0.4)] text-[#f5f5f0] text-xs px-4 py-1.5 rounded-full hover:bg-[rgba(245,245,240,0.1)] transition-all whitespace-nowrap"
        >
          ...
          <div className="flex flex-col">
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  ...
                  className={
                    isActive
                      ? "py-3 px-4 text-sm text-[#f5f5f0] border-b border-white/5 uppercase tracking-wider font-medium last:border-b-0"
            ...
            <div className="pt-3">
              <a
                ...
                className="flex items-center justify-center gap-2 w-full text-center py-3 px-4 rounded-xl border border-[rgba(245,245,240,0.4)] text-[#f5f5f0] text-sm hover:bg-[rgba(245,245,240,0.1)] transition-all"
              >
                Resume <ExternalLink size={12} />
              </a>
            </div>
