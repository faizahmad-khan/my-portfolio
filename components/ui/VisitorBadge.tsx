    ...
    <>
      ...
      >
        <motion.button
          ...
          className="relative inline-flex items-center gap-2 rounded-full border border-gold/25 bg-black/70 px-3 py-2 text-xs text-gray-200 shadow-[0_0_30px_rgba(245,166,35,0.12)] backdrop-blur-md transition-colors duration-300 hover:border-gold/50 cursor-pointer select-none"
        ...
        >
          ...
          <motion.div
            ...
            className="pointer-events-none absolute bottom-full left-0 mb-2 w-max max-w-[220px] rounded-xl border border-gold/20 bg-[#101010] px-3 py-2 text-[11px] text-gray-300 shadow-xl"
          >
