export default function GlowOrb() {
  return (
    <div className="relative w-48 h-48 flex items-center justify-center">
      ...
      {/* Center dot */}
      <div className="absolute w-3 h-3 rounded-full bg-cyan-400 glow-text shadow-lg shadow-cyan-400/80" />

      {/* Outer ambient glow */}
      <div className="absolute -inset-8 rounded-full bg-cyan-400/5 blur-2xl" />
    </div>
  );
}
